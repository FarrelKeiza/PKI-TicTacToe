...
void gameInitialization(){
		game mainGame;																				/* Tipe data bentukan yang berasal dari Struct.h yaitu Struct Game */
		player playerOne, playerTwo;																/* Tipe data bentukan yang berasal dari Struct.h yaitu Struct Player */
		int choice;																					/* Tipe data lokal choice untuk mengambil pilihan input dari user */
		
		mainGame.winObjective = 3;																	/* Inisialisasi default sebagai inputan simbol untuk kemenangan */
